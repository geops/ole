    ...
    addEditorControls: function () {
        ...
        for (var i = 0, len = editor.activeControls.length; i < len; i++) {
            ...
            switch (control) {
                ...
                default:
                    // Allow externally-defined controls, developers is responsible for providing a OpenLayers.Editor.Control[control] class
                    // and corresponding CSS.
                    // See FeatureStyler-example: lib.heron-mc.org/heron/latest/examples/vectorstyler (would require Heron/GXP/GeoExt).
