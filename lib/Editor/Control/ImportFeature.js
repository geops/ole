    ...
    importFeature: function () {
        ...
        if (this.map.editor.sourceLayers.length > 0) {
            ...
            for (var i = 0, li = this.map.editor.sourceLayers.length; i < li; i++) {
                for (var j = 0, lj = this.map.editor.sourceLayers[i].selectedFeatures; j < lj; j++) {
            ...
            if (importFeatures.length > 0) {
                ...
                this.map.editor.showStatus('error', OpenLayers.i18n('oleImportFeatureSourceFeature'));
            }

        } else {
            this.map.editor.showStatus('error', OpenLayers.i18n('oleImportFeatureSourceLayer'));
        }
    },
