...
//                console.log("remove feature from layer");
//                state.layer.removeFeatures(feature);
                if (fromStack.length > 0) {
                    ...
                    if (prevState.id == state.id) {
                        ...
                        return state;
                        console.log("restore prevState to layer");
//                        this.map.editor.editLayer.addFeatures(prevFeature);
                    }
                }
